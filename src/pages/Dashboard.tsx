...
import { TrendingUp, FileText, Calendar, BarChart3, Zap, Eye } from "lucide-react";
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Trending Opportunities</CardTitle>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {[
                  { topic: "#AITrends2025", engagement: "High", color: "bg-red-500" },
                  { topic: "#TechInnovation", engagement: "Medium", color: "bg-yellow-500" },
                  { topic: "#DigitalMarketing", engagement: "Rising", color: "bg-green-500" }
                ].map((trend, index) => (
