...
const BusinessKit = () => {
  const uploadedFiles = [
    ...
    {
      name: "Brand Voice Sample.txt",
      type: "text",
      size: "12 KB",
      status: "Processed",
    },
    {
      name: "Company Jingle.mp3",
      type: "audio",
      size: "3.1 MB",
      status: "Processed",
    },
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Upload and manage your business content to train our AI for better,
          ...
          <TabsContent value="upload">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Upload your business documents, media, and content for AI
                    analysis
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-indigo-500 transition-colors">
                    ...
                    <p className="text-xs text-gray-500 mt-2">
                      Supports: PDF, PNG, JPG, MP4, MP3, TXT, DOCX (Max: 50MB
                      per file)
                    </p>
                  </div>
                </CardContent>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Quickly add text content like mission statements, brand
                    voice examples, or product descriptions
                  </CardDescription>
                </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Upload these types of content to improve AI performance
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <div className="p-4 border rounded-lg text-center">
                    ...
                    <p className="text-sm text-gray-600">
                      Style guides, brand books, voice & tone documents
                    </p>
                  </div>
                  <div className="p-4 border rounded-lg text-center">
                    ...
                    <p className="text-sm text-gray-600">
                      Logos, product photos, brand imagery
                    </p>
                  </div>
                  <div className="p-4 border rounded-lg text-center">
                    ...
                    <p className="text-sm text-gray-600">
                      Promotional videos, tutorials, brand storytelling
                    </p>
                  </div>
                  <div className="p-4 border rounded-lg text-center">
                    ...
                    <p className="text-sm text-gray-600">
                      Jingles, voice samples, podcast excerpts
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <div className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    See how our AI interprets your uploaded content
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Key themes and topics identified from your content
                  </CardDescription>
                </CardHeader>
                <CardContent>
