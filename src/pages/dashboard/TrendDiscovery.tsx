  ...
  const trends = [
    {
      ...
      sentiment: "Positive",
      description:
        "Artificial Intelligence trends gaining massive traction across social media platforms.",
    ...
    },
    {
      ...
      sentiment: "Positive",
      description:
        "Growing interest in eco-friendly lifestyle choices and sustainable products.",
    ...
    },
    {
      ...
      sentiment: "Neutral",
      description:
        "Consistent demand for remote work productivity and wellness advice.",
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Discover trending topics and get AI-powered content ideas for your
            brand.
          </p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Based on trending topics and your brand voice
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 bg-blue-50 rounded-lg">
                ...
                <p className="text-blue-800 text-sm">
                  "How AI is revolutionizing small business operations - share
                  your experience with automation tools and their impact on
                  productivity."
                </p>
              ...
              <div className="p-4 bg-green-50 rounded-lg">
                ...
                <p className="text-green-800 text-sm">
                  "3 simple sustainable swaps that saved our office $200 last
                  month - which eco-friendly change made the biggest impact for
                  you?"
                </p>
                <Button size="sm" className="mt-3" variant="outline">
                  Use This Idea
