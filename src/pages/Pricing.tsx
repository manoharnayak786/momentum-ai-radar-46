  ...
  const allFeatures = [
    ...
    },
    {
      ...
      features: [
        ...
        {
          name: "Brand voice fine-tuning",
          creator: false,
          pro: true,
          agency: true,
        },
        {
          name: "Visual style training",
          creator: false,
          pro: true,
          agency: true,
        },
        {
          name: "Branded video generation",
          creator: false,
          pro: true,
          agency: true,
        },
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Simple, transparent pricing that scales with your needs. Start your
            14-day free trial on any plan today.
          </p>

          {/* Billing Toggle */}
          <div className="flex items-center justify-center space-x-4 mb-16">
            <span
              className={`text-lg ${!isYearly ? "text-gray-900 font-semibold" : "text-gray-500"}`}
            >
              Monthly
            </span>
            <button
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b">
                    ...
                    <th className="text-center py-4 px-6 font-semibold text-gray-900 bg-indigo-50">
                      Pro
                    </th>
                    <th className="text-center py-4 px-6 font-semibold text-gray-900">
                      Agency
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600">
                  You get full access to all Pro features for 14 days. No credit
                  card required. Set up your Brand Kit, connect your social
                  accounts, and experience the power of proactive AI.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600">
                  ...
                  any time. Changes take effect immediately, and we'll prorate
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Upload your best marketing content, and our AI analyzes your
                  writing style, tone, and vocabulary. We then fine-tune a
                  custom language model that generates content in your authentic
                  brand voice.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600">
                  We integrate with all major social platforms (Facebook,
                  Instagram, LinkedIn, X, TikTok), plus CRM systems (HubSpot,
                  Salesforce) and e-commerce platforms (Shopify, WooCommerce).
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-gray-900">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Join the growing community of brands using Momentum AI to stay ahead
            of trends and create authentic content at scale.
          </p>
          <Button
            size="lg"
